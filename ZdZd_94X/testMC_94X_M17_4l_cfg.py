...
myfilelist = cms.untracked.vstring(
        'root://cmsxrootd.fnal.gov//store/mc/RunIIFall17MiniAODv2/HToZdZdTo4L_M125_MZd15_eps2e-2_kap1e-4_TuneCP5_13TeV_madgraph_pythia8/MINIAODSIM/PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/30000/9C625B4B-06AF-E911-AA89-0025905A60A0.root',
        )
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("ZZGJetsTo4L2Nu_4f.root")
)
...
process.Ana = cms.EDAnalyzer('UFHZZ4LAna',
                              ...
                              CrossSection = cms.untracked.double(0.0009997),
